	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Source" Type="Folder">
			<Item Name="Controls" Type="Folder">
				<Item Name="Communication Mode.ctl" Type="VI" URL="../Controls/Communication Mode.ctl"/>
			...
			<Item Name="SubVIs" Type="Folder">
				...
				<Item Name="Sender User Event LV2.vi" Type="VI" URL="../SubVIs/Sender User Event LV2.vi"/>
			</Item>
		...
		<Item Name="Receiver Clone Cluster.ctl" Type="VI" URL="../Controls/Receiver Clone Cluster.ctl"/>
		<Item Name="Sender Clone Cluster.ctl" Type="VI" URL="../Controls/Sender Clone Cluster.ctl"/>
