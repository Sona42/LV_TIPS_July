...
<Project Type="Project" LVVersion="21008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Source" Type="Folder">
			<Item Name="Sample Text Files" Type="Folder">
				<Item Name="Introduction.txt" Type="Document" URL="../Sample Text Files/Introduction.txt"/>
				<Item Name="Output.txt" Type="Document" URL="../Sample Text Files/Output.txt"/>
				<Item Name="Result.txt" Type="Document" URL="../Sample Text Files/Result.txt"/>
				<Item Name="Testcase.txt" Type="Document" URL="../Sample Text Files/Testcase.txt"/>
			</Item>
			<Item Name="CustomSortPath.lvlib" Type="Library" URL="../CustomSortPath.lvlib"/>
			<Item Name="Datalog.csv" Type="Document" URL="../Datalog.csv"/>
			<Item Name="Test Files.lvlib" Type="Library" URL="../Test Files/Test Files.lvlib"/>
		</Item>
